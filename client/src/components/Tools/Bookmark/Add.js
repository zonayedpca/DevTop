    ...
    return (
      <div className="bookmark-add">
        <form onSubmit={this.handleSubmit.bind(this)}>
          <input name="name" value={name} onChange={this.handleInput.bind(this)} placeholder="Name it" />
          <input name="link" value={link} onChange={this.handleInput.bind(this)} placeholder="Add a new bookmark" />
...
export default connect(null, { addBookmark })(Add);
